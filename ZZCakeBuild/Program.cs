...
{
    public const string ProjectName = "RecenteringGears";
...
public sealed class PackageTask : FrostingTask<BuildContext>
{
    public override void Run(BuildContext context)
    {
        ...
        context.CopyFiles($"../{BuildContext.ProjectName}/bin/{context.BuildConfiguration}/Mods/recenteringgears/publish/*",
